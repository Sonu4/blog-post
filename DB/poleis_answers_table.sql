...
CREATE TABLE `answers_table` (
  ...
  `qustions_id` bigint(20) NOT NULL,
  `fk_user_key` bigint(20) NOT NULL,
  `i_support` varchar(10) NOT NULL,
  `i_dont` varchar(10) NOT NULL,
  `user_religion` varchar(50) NOT NULL,
  `user_sex` varchar(10) NOT NULL,
  `user_age` varchar(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `qustions_id` (`qustions_id`),
  KEY `fk_user_key` (`fk_user_key`),
  CONSTRAINT `answers_table_ibfk_1` FOREIGN KEY (`qustions_id`) REFERENCES `user_questions` (`id`),
  CONSTRAINT `answers_table_ibfk_2` FOREIGN KEY (`fk_user_key`) REFERENCES `user_mobno` (`id`)
